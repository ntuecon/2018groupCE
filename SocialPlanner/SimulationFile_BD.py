...
Base_Pr=0.8
Effect_Vaccin=3.0
Weight_of_Total_Consumption=1.0
gamma=1.0
...
color = 'tab:red'
ax1.set_xlabel('Badstate Discount')
...
#fig.legend()
fig.tight_layout()
fig.savefig('Welfare-BD.png',format='png')
plt.show()
'''
fig, ax1 = plt.subplots()
color = 'tab:red'
...
#fig.legend()
fig.tight_layout()
plt.savefig('Vaccin-BD_Rawl.png',format='png')
plt.show()
