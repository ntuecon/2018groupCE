...
color = 'tab:red'
ax1.set_xlabel('Absolute Weakness')
...
#fig.legend()
fig.tight_layout()
fig.savefig('Welfare-AW.png',format='png')
plt.show()
'''
fig, ax1 = plt.subplots()
color = 'tab:red'
...
#fig.legend()
fig.tight_layout()
plt.savefig('Vaccin-AW.png',format='png')
plt.show()
